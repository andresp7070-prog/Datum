...
// Versión simplificada de insights/filtro-fecha.tsx: solo el rango de
// fechas, sin día de la semana/producto/categoría/hora — esas dimensiones
// no aplican a leads ni a gastos internos de Datum.
export function FiltroPeriodo({ periodoActual }: { periodoActual: string }) {
  ...
  const hayFiltroActivo = periodoActual !== "todo";
