...
import { agregarInteraccionLead } from "./actions";
...
export function NuevaInteraccionForm({ leadId }: { leadId: string }) {
  ...
  async function guardar() {
    ...
    setGuardando(true);
    try {
      const resultado = await agregarInteraccionLead({ leadId, fecha, tipo, nota: nota.trim() });
      if (resultado.error) {
