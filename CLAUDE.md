...
- **Calificación manual de 0 a 5 estrellas** por cliente (`crm_contactos.calificacion`), puesta a mano desde la ficha (componente `Estrellas`, clic en una estrella la fija, clic en la ya puesta la quita). Se ve también en el directorio de inicio del CRM, en modo solo lectura. No se calcula sola — es una opinión de la persona sobre el cliente, no una métrica derivada de las compras.
